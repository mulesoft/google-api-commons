...
public abstract class BasePersonEntry<E extends BasePersonEntry<E>> extends
  ...
  public void setEmailAddresses(List<Email> emails) {
	  this.setRepeatingExtension(Email.class, emails);
  }
  ...
  public void setHobbies(List<Hobby> hobbies) {
	  this.setRepeatingExtension(Hobby.class, hobbies);
  }
  ...
  public void setOrganizations(List<Organization> organizations) {
	  this.setRepeatingExtension(Organization.class, organizations);
  }
  ...
  public void setPhoneNumbers(List<PhoneNumber> numbers) {
	  this.setRepeatingExtension(PhoneNumber.class, numbers);
  }
  ...
  public void setPostalAddresses(List<PostalAddress> addresses) {
	  this.setRepeatingExtension(PostalAddress.class, addresses);
  }
  ...
  public void setWebsites(List<Website> websites) {
	  this.setRepeatingExtension(Website.class, websites);
  }
  /**
