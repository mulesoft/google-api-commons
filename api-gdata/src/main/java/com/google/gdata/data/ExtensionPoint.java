...
public class ExtensionPoint extends AbstractExtension {
  ...
  protected transient XmlBlob xmlBlob = new XmlBlob();
   ...
   */
  @SuppressWarnings("unused") private transient final Collection<Extension> extensions = null;
  @SuppressWarnings("unused") private transient final Collection<Extension> repeatingExtensions = null;
  ...
  @SuppressWarnings("unchecked")
  public <T extends Extension> void setRepeatingExtension(Class<T> extensionClass, List<T> value) {
      repeatingExtensionMap.put(extensionClass, (List<Extension>) value);
  }
